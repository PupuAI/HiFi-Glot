...
def generate_wave_list(file_list, a, h, fm_h):
    ...
    feature_mapping.load_state_dict(state_dict)
    feature_mapping = feature_mapping.to(device)
    feature_mapping.eval()

    state_dict = load_file(f"{a.checkpoint_path.split('.safetensors')[0]}_1.safetensors")
    ...
    for file in tqdm(file_list, total = len(file_list)):
        ...
        y_mel = feature_mapping(norm_feat)
